...
Source0  : http://download.savannah.gnu.org/releases/libunwind/libunwind-1.3.0.tar.gz
...
%prep
%setup -q -n libunwind-1.3.0
pushd ..
cp -a libunwind-1.3.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1547052540
